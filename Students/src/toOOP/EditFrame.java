...
public class EditFrame extends JFrame {
	...
	public EditFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\3course\\OOP\\Карт.png"));
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					prst.execute();
					JOptionPane.showMessageDialog(null, "Дані введено");

					prst.close();


				} catch (SQLException e1) {
					JOptionPane.showMessageDialog(null, "Помилка при введенні даних");
					e1.printStackTrace();
				}
				refreshTable();
			}
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Помилка при оновленні даних");
					e1.printStackTrace();
				}
				refreshTable();
			}
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int action = JOptionPane.showConfirmDialog(null, "Видалення даних тільки по ПІБ",
						"Ïîâ³äîìëåííÿ", JOptionPane.OK_CANCEL_OPTION);
				if (action == 0) {
					try {
						...
						JOptionPane.showMessageDialog(null, "Помилка при видаленні даних");
						e1.printStackTrace();
					}
					refreshTable();
				}
