...
public class EditFrame extends JFrame {
	...
	public EditFrame(){
		...
		btnInsert.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				try {
					...
					prst.execute();
					JOptionPane.showMessageDialog(null, "<html>Дані введено");
					
					prst.close();


				} catch (SQLException e1) {
					JOptionPane.showMessageDialog(null, "<html>Помилка при введенні даних");
					e1.printStackTrace();
				}
				refreshTable();
			}
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					prst.execute();
					JOptionPane.showMessageDialog(null, "<html> Дані оновлено");

					prst.close();


				} catch (SQLException e1) {
					JOptionPane.showMessageDialog(null, "<html> Помилка при оновленні даних");
					e1.printStackTrace();
				}
				refreshTable();
			}
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int action = JOptionPane.showConfirmDialog(null, "<html> Видалення проводиться тільки по полю ПІБ",
						"Видалення даних", JOptionPane.OK_CANCEL_OPTION);
				if (action == 0) {
					try {
						...
						prst.execute();
						JOptionPane.showMessageDialog(null, "<html> Дані видалено");

						prst.close();


					} catch (SQLException e1) {
						JOptionPane.showMessageDialog(null, "<html> Помилка при видаленні даних");
						e1.printStackTrace();
					}
					refreshTable();
				}
